...
| eventType | Integer | 영역 속성 (**[EventType](/docs/v2/models.md#eventtype)**)| O |
| roiName | String | 이벤트 이름 | O |
| roiType | Integer | ROI 타입 (**[DrawingType](#drawing-type)**) | O |
| feature | Integer | ROI 감지 (**[ROI Feature](/docs/v2/models.md#roi-feature)**) | O |
| roiDots | JsonObject[] | ROI 라인 설정 (**[RoiDot](#roi-dot)**) | O |
| EventFilter | Integer | 객채 검출 사이즈 필터 (**[EventFilter](#event-filter)**)| O |
...
| code | Integer | 응답 코드 (**[Error Code](/docs/v2/models.md#error-code)**) |
...
| Name | Type | Description | Required |
| :---- | :---- |:---- |:---- |
| minDetectSize | Integer | 최소 객체 크기 (미구현) | O |
| maxDetectSize | Integer | 최대 객체 크기 (미구현) | O |
| objectsTarget | Integer | 검출 객체 (**[RoiLine](#roi-line)**) | O |
